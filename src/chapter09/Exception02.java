...
public class Exception02 {
	public static void main(String[] args) {
		...
		//Syntax error on token "-", delete this token 런타임 cannot be resolved to a type Syntax error, insert ";" to complete LocalVariableDeclarationStatement
		...
		try {
			...
			int[] numbers = new int[5]; // new int[배열크기]
