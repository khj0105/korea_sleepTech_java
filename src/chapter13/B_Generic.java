...
public class B_Generic {
	public static void main(String[] args) {
		...
		m1 = new Message<>();
		String s = (String) m1.getMessage(); // 명시적 형 변환 (강제 형 변환) m1=obejct s=String
		...
		// ? : 어떤 타입이든 허용
		// >> 와이드 카드의 구조체에 값을 할당하는 경우 컴파일러가 구체적인 타입을 확인할 수 없어 오류 발생
		...
		// list2.add(123); - 구체적인 숫자 값 추가 불가 (타입 안정성 보장 불가1) number 값은 정수, 실수 다 포함이기에 구체적인 숫자 값 추가 불가
