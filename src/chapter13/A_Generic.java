...
public class A_Generic {
	public static void main(String[] args) {
		...
		// cf) 제네릭 타입 명시는 필수 X
		//		: 제네릭 타입의 구조에 값이 들어올 경우 해당 값으로 타입을 자동 유추하고 값이 할당
		
		Pair<Integer, String> pair1 = new Pair<>(123, "안녕하세요"); //  new Pair에서 Pair는 생성자역할, 인자값으로 타입을 자동 유추
		Pair<Integer, String> pair2 = new Pair<Integer, String>(123, "안녕하세요"); //  new Pair에서 Pair는 생성자역할, 인자값으로 타입을 자동 유추
		// 좌항의 클래스타입에는 타입 명시
