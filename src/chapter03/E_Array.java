...
public class E_Array {
	public static void main(String[] args) {
		...
		// - Java Colletion FramWork의 일부: 'java.util.ArrayList'에서 제공
		...
		// +) Collection Framwork의 모든 클래스 내부에서는 객체 구조만을 다룸
		//		: 기본 타입 사용 X
		...
		// [], 내부 배열이 처음 생성될 때 크기가 10으로 설정된다는 것입니다. 
		//그러나, 이 배열은 요소를 담을 공간만 미리 할당한 것일 뿐, 실제로 저장된 데이터는 없습니다.
