...
class Student {
	...
	void updateGpa(double newGpa) {
		...
		public Student(int id, String name2, String major2, double gpa2) {
...
//		Student student2 = new Student(2, "이도경", 30, "슬립테크", 3.0);
//		Student student3 = new Student(3, "이지희", 30, "슬립테크", 4.2);
//		Student student4 = new Student(4, "이지훈", 30, "슬립테크", 3.5);
//		
...
//		studentList.add(student4);
		...
		addStudent(2, "이도경", 30, "슬립테크", 3.0);
		addStudent(3, "이지희", 30, "슬립테크", 4.2);
		addStudent(4, "이지훈", 30, "슬립테크", 3.5);
