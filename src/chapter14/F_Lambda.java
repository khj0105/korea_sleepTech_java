...
public class F_Lambda {
	public static void main(String[] args) {
		...
		// 1. 정적 메서드 참조
		// 1) 람다 표현식
		Function<Integer, Integer> doubleLambda = x -> StaticMethodRef.doubleValue(x); // 10
		// 2) 메서드 참조
		Function<Integer, Integer> doubleLambdaRef = StaticMethodRef::doubleValue; // 20
		
		System.out.println(doubleLambda.apply(5));
		System.out.println(doubleLambda.apply(10));
