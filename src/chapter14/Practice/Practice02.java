...
//		highSalaryEmployees.forEach(System.out::println);
		...
		// 2) 부서가 'IT'인 직원 목록을 전체 순회하여 이름만 추출 - map (대응하는 값을 반환)
...
//		List<String> hrEmployeeNames = employees.stream()
...
//				.collect(Collectors.groupingBy(employee -> employee.getDepartment()));
		...
		//{OP=[Employee(department=OP, name=전예찬, salary=350)], HR=[Employee(department=HR, name=조승범, salary=500), 
		//Employee(department=HR, name=윤대휘, salary=380)], IT=[Employee(department=IT, name=이승아, salary=300), 
