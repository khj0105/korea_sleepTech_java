...
//		: 사과 꺼내기 - 순차적인 수를 사용한 꺼내기 (속도 향상)

// 2) LinkedList
// : 내부에서 이중 연결 리스트를 사용한 요소 저장
// - 빠른 삽입, 삭제 성능 / 느린 읽기 성능
// - 연결 기반 데이터 관리: 비순차적 데이터 작업에 적합, 특정 요소 접근 시 순챁 탐색이 필요하여 성능 저하
...
public class B_List {
	public static void main(String[] args) {
		...
		// List 인터페이스 >(implement) AbstractList 추상 클래스 >(extends) ArrayList 클래스 
		...
		System.out.println(startTime); // 21880836213800
